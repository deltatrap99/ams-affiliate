...
// Rename campaign and make it a link to topuni-detail.html
content = content.replace(
    '<div class="db-camp-name">TopUni 2027 — Lộ trình S V-ACT</div>',
    '<a href="topuni-detail.html" class="db-camp-name" style="text-decoration:none;">[HOCMAI] Lộ trình TopUni S-VACT</a>'
);

// Add onclick to button pointing to topuni-detail.html
content = content.replace(
    '<button class="btn-f dark">Xem brief</button>',
    '<button class="btn-f dark" onclick="window.location.href=\'topuni-detail.html\'">Xem brief</button>'
);
